...
class RegistrationScreen extends StatelessWidget {
  ...
  void registerNewUser(BuildContext context) async
  {
    ...
    final User firebaseUser = (await _firebaseAuth.createUserWithEmailAndPassword  // After final, include FirebaseUser
    ...
    if(firebaseUser != null) //user created
    {
    ...
    else
      {
        ...
        displayToastMessage("New user account has not been Crested", context);
      }
  }
